...
s.addText("正しい受診先を知る", {
  ...
  fontSize: 36, fontFace: "BIZ UDPGothic", color: C.yellow, bold: true, align: "center", margin: 0,
});
...
// Key points
var points = [
  { text: "脳神経内科", color: C.primary },
  { text: "整形外科", color: C.green },
  { text: "内科の違い", color: C.orange },
];
...
points.forEach(function(p, i) {
  ...
  s.addText(p.text, {
    ...
    fontSize: 19, fontFace: "BIZ UDPGothic", color: C.white, bold: true, align: "center", valign: "middle", margin: 0,
  });
});
