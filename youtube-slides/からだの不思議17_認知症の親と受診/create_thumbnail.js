...
// Main title line 1
s.addText("認知症の親を", {
  x: 0.3, y: 1.3, w: 9.4, h: 1.0,
  fontSize: 54, fontFace: "BIZ UDPGothic", color: C.white, bold: true, align: "center", margin: 0,
});

// Main title line 2
s.addText("病院に連れて行くには", {
  x: 0.3, y: 2.25, w: 9.4, h: 1.0,
  fontSize: 42, fontFace: "BIZ UDPGothic", color: C.yellow, bold: true, align: "center", margin: 0,
});

// Separator
s.addShape(pres.shapes.LINE, { x: 2, y: 3.4, w: 6, h: 0, line: { color: C.accent, width: 2 } });

// Key points (3 badges)
var points = [
  { text: "病識低下とは？", color: C.red },
  { text: "3つのアプローチ", color: C.yellow },
  { text: "相談窓口を使う", color: C.green },
];
