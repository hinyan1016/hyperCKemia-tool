...
// Main title line 2 (accent question)
s.addText("＝ 脳の問題？", {
  x: 0.3, y: 2.4, w: 9.4, h: 1.0,
  fontSize: 48, fontFace: "BIZ UDPGothic", color: C.yellow, bold: true, align: "center", margin: 0,
});
...
// Key points (3 badges)
var points = [
  { text: "5つの歩行システム", color: C.green },
  { text: "NPH・パーキンソン病", color: C.yellow },
  { text: "受診判断フロー", color: C.red },
];
