...
// Main title line 1
s.addText("利き手はなぜ決まる？", {
  x: 0.3, y: 1.3, w: 9.4, h: 1.1,
  fontSize: 50, fontFace: "BIZ UDPGothic", color: C.white, bold: true, align: "center", margin: 0,
});
// Main title line 2
s.addText("脳の左右差を解説", {
  x: 0.3, y: 2.35, w: 9.4, h: 0.9,
  fontSize: 38, fontFace: "BIZ UDPGothic", color: C.yellow, bold: true, align: "center", margin: 0,
});
...
// Key points (3 badges)
var points = [
  { text: "遺伝と脳の非対称", color: C.green },
  { text: "言語優位半球との関係", color: C.yellow },
  { text: "矯正は不要", color: C.red },
];
