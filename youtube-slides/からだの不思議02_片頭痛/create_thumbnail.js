...
// Key point badges
var points = [
  { text: "薬の飲みすぎNG", color: C.red },
  { text: "予防薬がある", color: C.green },
  { text: "危険な頭痛を見分ける", color: C.orange },
];

points.forEach(function(p, i) {
  var xPos = 0.5 + i * 3.1;
  s.addShape(pres.shapes.RECTANGLE, { x: xPos, y: 3.6, w: 2.8, h: 0.65, fill: { color: p.color } });
  s.addText(p.text, {
    x: xPos, y: 3.6, w: 2.8, h: 0.65,
